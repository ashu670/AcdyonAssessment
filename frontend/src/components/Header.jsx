    ...
    <header className="bg-white border-b border-gray-200 sticky top-0 z-30 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6">
          ...
          >
            <div className="w-9 h-9 rounded-xl bg-black text-white flex items-center justify-center font-black text-lg group-hover:scale-105 transition-transform shadow-md">
              ✕
            </div>
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          {sandboxActiveCount > 0 && (
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-bold text-amber-900 bg-amber-100 border border-amber-300 rounded-full transition hover:bg-amber-200"
              title="Click to manage Sandbox Overrides"
            >
              <span className="w-2 h-2 rounded-full bg-amber-600 animate-ping" />
              <span>Sandbox Active ({sandboxActiveCount})</span>
            </button>
          )}
          ...
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 text-xs font-semibold text-gray-700 hover:text-black transition focus:outline-none"
            >
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-black hover:bg-gray-800 text-white text-xs font-bold rounded-xl transition shadow-sm active:scale-95 whitespace-nowrap shrink-0"
          >
